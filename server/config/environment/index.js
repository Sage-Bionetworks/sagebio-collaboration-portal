...
var all = {
    ...
    authStrategies: [
        ...
        !!process.env.AZUREAD_OPENIDCONNECT_CLIENT_ID | process.env.AZUREAD_OPENIDCONNECT_ENABLED
    ...
    provenance: {
        apiServerUrl:
            `${process.env.PROVENANCE_API_SERVER_PROTOCOL
            }://${
...
// ==============================================
module.exports = _.merge(all, require('./shared').default, require(`./${process.env.NODE_ENV}.js`) || {});
