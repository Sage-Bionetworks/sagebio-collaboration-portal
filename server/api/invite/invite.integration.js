...
describe('Invite API:', function() {
  ...
  describe('PUT /api/invites/:id', function() {
    ...
    it('should respond with the updated invite', function() {
      expect(updatedInvite.name).to.equal('Updated Invite');
      expect(updatedInvite.info).to.equal('This is the updated invite!!!');
    });
