...
export function index(req, res) {
    return StarredMessage.find().exec()
...
export function upsert(req, res) {
    ...
    return StarredMessage.findOneAndUpdate({_id: req.params.id}, req.body, {new: true, upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
        .then(respondWithResult(res))
        .catch(handleError(res));
}
